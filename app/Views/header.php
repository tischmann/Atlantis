        ...
        <div class="flex flex-row md:items-center flex-wrap md:justify-between gap-4">
            ...
            if (App::getCurrentUser()->exists()) {
                if (App::getCurrentUser()->isAdmin()) {
                    echo <<<HTML
                    <a href="/{{env=APP_LOCALE}}/users" aria-label="{{lang=user_list}}" title="{{lang=user_list}}" class="inline-block select-none rounded-xl px-3 py-2 bg-gray-200 hover:bg-gray-300 ">
