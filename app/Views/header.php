    ...
    <div class="md:container md:mx-auto p-4">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4">
            ...
            <div class="flex gap-4 items-center">
                <form class="relative flex items-center w-full md:w-auto" method="GET">
                    <input type="search" class="relative m-0 block w-1/3 min-w-0 flex-auto rounded-lg border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-1.5 text-base font-normal text-neutral-700 outline-none transition duration-300 ease-in-out focus:border-primary-600 focus:text-neutral-700 focus:shadow-te-primary focus:outline-none dark:border-neutral-600 dark:text-neutral-200 dark:placeholder:text-neutral-200" placeholder="{{lang=search}}" aria-label="{{lang=search}}" name="search" value="<?= $search ?>" />
