...
<a href="/{{env=APP_LOCALE}}/edit/article/<?= $article->id ?>" title="<?= $article->title ?>" class="group/item block p-4 rounded-xl border-2 border-gray-200 hover:border-gray-300">
    <article>
        ...
        <div class="relative">
            ...
            <img src="<?= $image ? "/images/articles/{$article->id}/image/thumb_{$image} " : "/images/placeholder.svg" ?>" alt="<?= $article->title ?>" width="400" height="300" class="bg-gray-200 w-full rounded-lg mb-4" decoding="async" loading="lazy">
        </div>
