<main class="container mx-auto">
        ...
        if ($category->children) {
            ...
            <div class="mb-4">
                <div class="form-label inline-block mb-1 text-gray-500">{{lang=category_children}}</div>
                    <div class="bg-sky-400 rounded-xl text-sky-800 p-4">
            HTML;
    ...
    if ($category->id) {
        echo <<<HTML
                <dialog id="deleteDialod" class="rounded-xl shadow-xl relative w-96">
                    <form method="dialog">
        ...
        echo <<<HTML
                ...
                <div class="flex items-center gap-4">
                    <button value="cancel"
                    class="inline-block w-full px-6 py-2.5 bg-gray-600 text-white font-medium text-xs leading-tight uppercase rounded-lg shadow-md hover:bg-gray-700 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out">{{lang=no}}</button>
                <button value="default"
                    class="inline-block w-full px-6 py-2.5 bg-pink-600 text-white font-medium text-xs leading-tight uppercase rounded-lg shadow-md hover:bg-pink-700 hover:shadow-lg focus:bg-pink-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-pink-800 active:shadow-lg transition duration-150 ease-in-out">{{lang=yes}}</button>
                </div>                        
            </form>
        </dialog>
        <script nonce="{{nonce}}">
