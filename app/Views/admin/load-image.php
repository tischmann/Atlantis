<div class="mb-4">
    ...
    <img src="{{src}}" width="{{width}}" height="{{height}}" alt="{{label}}" class="rounded w-full object-cover border border-gray-300 cursor-pointer" data-atlantis-image-load data-token="{{csrf-token}}" data-url="{{url}}" data-placeholder="/images/placeholder.svg">
