...
<a href="<?= $href ?>" title="<?= $article->title ?>" class="group/item block p-4 rounded-xl border-2 border-gray-200 hover:border-gray-300">
    <article>
        ...
        <div class="relative">
            ...
            <img src="<?= $article->getImage() ? "/images/articles/{$article->id}/image/thumb_{$article->getImage()} " : "/images/placeholder.svg" ?>" alt="<?= $article->title ?>" width="400" height="300" class="bg-gray-200 w-full rounded-lg mb-4" decoding="async" loading="lazy">
        </div>
        <div class="mb-4 text-gray-600 text-sm flex justify-between items-center flex-nowrap gap-2">
            <div class="flex flex-row flex-nowrap gap-2 items-center grow">
