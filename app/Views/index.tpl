<main class="w-screen h-screen flex flex-col items-center justify-center text-sky-600 dark:text-gray-700">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        viewBox="0 0 400 400" xml:space="preserve" width="256px" height="256px">
