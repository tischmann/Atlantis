...
<div class="rounded-lg shadow-lg bg-white dark:bg-sky-800 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6">
    <div class="text-sky-800 text-xs h-56 md:h-full w-full rounded-t-lg md:rounded-none md:rounded-l-lg bg-cover bg-center min-h-[180px]" data-lazy-bg="<?= $article->image_url ?>">
