<main class="w-screen h-screen flex flex-col items-center justify-center select-none">
    ...
    <div class="block p-6 rounded-lg bg-white dark:bg-gray-700 w-full max-w-sm">
        <form method="post">
            {{csrf}}
            <div class="relative mb-6" data-te-input-wrapper-init>
                <input type="text" name="login" required
                    class="peer block min-h-[auto] w-full rounded border-0 bg-white dark:bg-gray-700 text-gray-800 dark:text-white py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
