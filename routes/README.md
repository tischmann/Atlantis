...
ADD_DEV — режим разработчика (0, 1, по умолчанию 1)
...
Шаблоны с расширением .tpl используются для представлений, которые не используют PHP код.

Шаблоны с расширением .php используются для представлений, которые используют PHP код.
