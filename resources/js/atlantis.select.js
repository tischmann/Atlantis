export default class Select {
    ...
    constructor(element, { onchange = function () {}, token = '' } = {}) {
        ...
        this.wrapper.classList.add('relative', 'w-full', 'grow')
        ...
        this.label.textContent = this.element.title
    ...
    handleEvent(event) {
        ...
        switch (event.type) {
            case 'click':
                if (target.closest('[data-atlantis-select]') === this.button) {
                    return this.#selectClickHandler(event)
                } else if (
                    this.options.has(target.closest('[data-atlantis-option]'))
                ) {
    ...
    #createOption({
        ...
        li.setAttribute('data-atlantis-option', '')
    ...
    #optionClickHandler(event) {
        const target = event.target.closest('[data-atlantis-option]')
    ...
    destroy() {
        ...
        this.wrapper.parentElement.replaceWith(this.element, this.wrapper)
    }
}
